...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    // call smithy function
      return playSmithy(card, choice1, choice2, choice3, state, handPos);
...
int playSmithy(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos)
{
      //+3 Cards
      for (i = 0; i < 3; i++)
	{
